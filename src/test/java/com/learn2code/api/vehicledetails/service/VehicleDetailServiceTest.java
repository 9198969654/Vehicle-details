...
class VehicleDetailServiceTest {
    ...
    void setUp() {
        ...
        vd.setDescription("Excellent, Pretty new, 3 years manufacturer warrenty, Amazing Milaze: ");
    ...
    void saveVehicleDetails() throws VehicleNotSaved {
        ...
        input.setDescription("Excellent, Pretty new, 3 years manufacturer warrenty, Amazing Milaze: ");
    ...
    @Test
    @DisplayName("Get All Vehicle from database")
    public void fetchAllVehicleDetailsTest() throws VehicleDetailsNotFound {
